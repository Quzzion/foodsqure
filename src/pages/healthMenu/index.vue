        ...
        <div class="mainNav">
          ...
          >
            <el-submenu index="group1">
              ...
              <el-menu-item-group title="功能性食谱">
                <el-menu-item index="2">祛痰</el-menu-item>
                <el-menu-item index="3">乌发</el-menu-item>
                <el-menu-item index="4">滋阴补肾</el-menu-item>
                <el-menu-item index="5">健脾开胃</el-menu-item>
                <el-menu-item index="6">消化不良</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
        </div>
        <div class="menu">
          <div class="list_title">健康菜单列表</div>
          <div class="list_sort">
            <span>智能推荐</span>
            <span>智能推荐</span>
            <span>智能推荐</span>
